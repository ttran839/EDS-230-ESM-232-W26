...
* wildfire smoke impacts on drinking water 
  ...
  - parameters/inputs  (wildfire size, wind, precipitation, water flow, biomass lost in fire)
(really complicated as a dynamic model, versus simple statistical model of smoke impacts on water quality)
...
<span style="color: blue;"> 1)  explicit solution to differential equation is known;  </span>
...
<span style="color: blue;"> 2)  not integrable </span>
...
If we use whole number jumps = e.g t, t+1, t+2 - we are doing a "discrete" approximation to the continuous change
...
Diffusion in 4 dimensions (x,y,z,t) can be modelled using partial differential equations
  - time and space! it gets much more tricky ...beyond this course
...
More info on differential equations in Python
- [scipy](https://docs.scipy.org/doc/scipy/reference/integrate.html#module-scipy.in has solvers for ordinary and partial differential equations
