...
Erosion can be a threshold-driven process where runoff only occurs when rainfall intensity exceeds the soil infiltration capacity. 
Erosion then
scales nonlinearly with runoff.
